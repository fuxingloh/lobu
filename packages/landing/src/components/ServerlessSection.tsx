      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="text-center mb-16">
          <a
            ...
            class="inline-flex items-center gap-2 text-xs font-medium px-3 py-1.5 rounded-full mb-6 transition-opacity hover:opacity-80"
            style={{
          ...
          >
            We run the infrastructure so you don't have to. Pay only when
            they're working.
          </p>
          ...
          <div class="flex items-center justify-center gap-3 mb-4">
            ...
            >
              <span
                ...
                style={{
                  transform: monthly ? "translateX(22px)" : "translateX(4px)",
                }}
              />
            </button>
            <span
