...
## [6.0.0](https://github.com/fuxingloh/lobu/compare/lobu-v5.0.0...lobu-v6.0.0) (2026-04-28)
...
* **db:** convert entities.entity_type to entity_type_id FK ([#370](https://github.com/fuxingloh/lobu/issues/370))
* **core, worker:** drop unused public exports from @lobu/core ([#281](https://github.com/fuxingloh/lobu/issues/281))

### Features

* add /skills/for/{useCase} routes, version eval schema, clean up duplication ([d84a856](https://github.com/fuxingloh/lobu/commit/d84a856a307916b87641426e0d2de48f89442089))
* add agent-community use case and extract UseCaseTabs label prop ([ba956ad](https://github.com/fuxingloh/lobu/commit/ba956ad13bdb642e22c3ed6bc2a7c00128d2ff72))
* add Bedrock provider and AWS deployment docs ([#171](https://github.com/fuxingloh/lobu/issues/171)) ([9210a36](https://github.com/fuxingloh/lobu/commit/9210a362f8bbc85ac37ded05e6fb95173d1f12a0))
* add ecommerce use case to landing page ([4982606](https://github.com/fuxingloh/lobu/commit/498260638532f7da16400a0bf6f1aca7e8ff3f46))
* add privacy policy page and footer link ([b9df04f](https://github.com/fuxingloh/lobu/commit/b9df04fffab714edaa569f447bb29b96c0c65c07))
* add Reddit and X (Twitter) as OAuth integrations ([7a57b9c](https://github.com/fuxingloh/lobu/commit/7a57b9c7b8a1f021923a5718c63e95000d20cf3e))
* add separate Lobu and Owletto starter skill installs ([#304](https://github.com/fuxingloh/lobu/issues/304)) ([d0a4bc4](https://github.com/fuxingloh/lobu/commit/d0a4bc4d7ef61c56250b698805ae854396391469))
* **agents:** public install endpoint for template agents ([#357](https://github.com/fuxingloh/lobu/issues/357)) ([4fb42ed](https://github.com/fuxingloh/lobu/commit/4fb42edc321afcaabc4f84add654ec8c4a290df6))
* **agents:** public install manifest endpoint + slug-based install ([#362](https://github.com/fuxingloh/lobu/issues/362)) ([74d8e39](https://github.com/fuxingloh/lobu/commit/74d8e398de9821c8b168e9d5ed7a095940751757))
* **agents:** schema-mirror + install flow for template agents ([#369](https://github.com/fuxingloh/lobu/issues/369)) ([48bdb20](https://github.com/fuxingloh/lobu/commit/48bdb201fd88ec5054544bcbe791efd2ae4a1d80))
* **auth:** auto-provision personal org on user signup ([#352](https://github.com/fuxingloh/lobu/issues/352)) ([deff32a](https://github.com/fuxingloh/lobu/commit/deff32aa14c8d7d0bf9b4dcfc38fbe25de51e740))
* **auth:** provision $member entity + identities on signup and install ([#359](https://github.com/fuxingloh/lobu/issues/359)) ([db1e199](https://github.com/fuxingloh/lobu/commit/db1e199b1f3ee92c4afcaae549faf8359965cf01))
* **backend:** wildcard trusted origins + reserved subdomain skip-list ([#214](https://github.com/fuxingloh/lobu/issues/214)) ([7656f2b](https://github.com/fuxingloh/lobu/commit/7656f2bf465a0cb2ea7eb91ec123c42ae015bb02))
* **ci:** autonomous PR triage workflow ([#349](https://github.com/fuxingloh/lobu/issues/349)) ([1fd4add](https://github.com/fuxingloh/lobu/commit/1fd4add1c69f62e11f5a9a788017253ff23fb0af))
* **ci:** migrate Docker images from Docker Hub to GHCR ([c01824a](https://github.com/fuxingloh/lobu/commit/c01824a6e7a59ee202145df5471ee9f863380eb3))
* **cli,gateway:** multi-agent CLI, external OAuth, agent seeding ([d4dba49](https://github.com/fuxingloh/lobu/commit/d4dba4998f2914d07d9528abc0a3b48a564ec8cc))
* **cli,landing:** add connections CLI + themeable chat component ([506b91c](https://github.com/fuxingloh/lobu/commit/506b91c5f4136c3867b509b4c2c52529d14ab778))
* **cli:** add lobu eval command with model comparison and CI workflow ([910da9b](https://github.com/fuxingloh/lobu/commit/910da9bd32fbc4f38a9479f3d5b070fe6def52b2))
* **cli:** add WhatsApp, Teams, and Google Chat to init platform choices ([d140b3b](https://github.com/fuxingloh/lobu/commit/d140b3be6f67958c843dfe29df74976897576fef))
* **config:** add system skills for integrations and LLM providers ([de25b3c](https://github.com/fuxingloh/lobu/commit/de25b3c885c6ec1301da998a1c38aac371b8e430))
* consolidate owletto into the lobu monorepo (PRs 1–4) ([#212](https://github.com/fuxingloh/lobu/issues/212)) ([a6d0d3f](https://github.com/fuxingloh/lobu/commit/a6d0d3f9a46696b5874e1a4029ab8f73e579a4e3))
* **core:** add guardrail primitive ([#254](https://github.com/fuxingloh/lobu/issues/254)) ([#317](https://github.com/fuxingloh/lobu/issues/317)) ([912dfff](https://github.com/fuxingloh/lobu/commit/912dfffbe78a3cfa0e0664338ee8a9c4fd826110))
* **db:** convert entities.entity_type to entity_type_id FK ([#370](https://github.com/fuxingloh/lobu/issues/370)) ([ab7ecde](https://github.com/fuxingloh/lobu/commit/ab7ecde23bc0d257595fa44c6e16cecdbfb3966e))
* **examples:** add LLM-judged ping eval to each surfaced example ([#366](https://github.com/fuxingloh/lobu/issues/366)) ([d6aa5ad](https://github.com/fuxingloh/lobu/commit/d6aa5adb70f98220a3b583a994d0a155c86bed07))
* **examples:** add personal-finance project for UK Self Assessment ([#350](https://github.com/fuxingloh/lobu/issues/350)) ([5852ea6](https://github.com/fuxingloh/lobu/commit/5852ea6de6650077ca7ed025f3b9f8924a4117cf))
* **examples:** company-aware world model for personal-finance ([#358](https://github.com/fuxingloh/lobu/issues/358)) ([0df7e19](https://github.com/fuxingloh/lobu/commit/0df7e190a0e901cbdbdcb8b1107648dc45b7083b))
* **examples:** evals for personal-finance agent (SA102/SA105/SA108 + behavioral) ([#356](https://github.com/fuxingloh/lobu/issues/356)) ([cf49872](https://github.com/fuxingloh/lobu/commit/cf49872e09ab866577b193aff44c39d33506f813))
* **examples:** Phase 2 — FX, allowance windows, filing timeline ([#360](https://github.com/fuxingloh/lobu/issues/360)) ([820af04](https://github.com/fuxingloh/lobu/commit/820af0430d54ae798a2aa577f81e95af157b8dde))
* **examples:** SA100 assembly playbook for personal-finance agent ([#354](https://github.com/fuxingloh/lobu/issues/354)) ([76d627d](https://github.com/fuxingloh/lobu/commit/76d627d61795c0ef5cbdff67c81382340d15132f))
* **examples:** statement ingestion playbook + Nix tooling ([#355](https://github.com/fuxingloh/lobu/issues/355)) ([d82d76c](https://github.com/fuxingloh/lobu/commit/d82d76ce236ad98d754f13a2da0ba02373d142b7))
* expand landing use cases and normalize network grants ([e9b0282](https://github.com/fuxingloh/lobu/commit/e9b02825b2c721fa4cde8a5a68d07e5ddfd4c993))
* **gateway:** add MCP OAuth 2.1 auth-code + PKCE flow ([9ea9f45](https://github.com/fuxingloh/lobu/commit/9ea9f45dedb9aa0f5ef740b949cd6b51fa8bf2ee))
* **gateway:** add optional body text to link-button cards ([#183](https://github.com/fuxingloh/lobu/issues/183)) ([1e93013](https://github.com/fuxingloh/lobu/commit/1e93013d542d4021fe33b4029b58b6329c4b19bd))
* **gateway:** embedded runtime credential resolver + secret-backed device auth ([8b3053a](https://github.com/fuxingloh/lobu/commit/8b3053a80c5aeb3fa05bcf1e3c379a691103c882))
* **gateway:** file-driven agent schedules in lobu.toml ([#211](https://github.com/fuxingloh/lobu/issues/211)) ([6b2eb51](https://github.com/fuxingloh/lobu/commit/6b2eb5128584d0d7d7cfaa38f203684ce422709f))
* **gateway:** Gemini Code Assist OAuth for CI smoke ([#315](https://github.com/fuxingloh/lobu/issues/315)) ([e4957d0](https://github.com/fuxingloh/lobu/commit/e4957d007993268dbaf7074721953da5a88205cd))
* **gateway:** LLM-judged egress via per-skill `action: judge` ([#319](https://github.com/fuxingloh/lobu/issues/319)) ([#327](https://github.com/fuxingloh/lobu/issues/327)) ([0171679](https://github.com/fuxingloh/lobu/commit/017167907246f65ae83da6091b0b5b6670c4fe2d))
* **gateway:** proxy-driven MCP tool approval with execute-on-approve ([cde529a](https://github.com/fuxingloh/lobu/commit/cde529ac3433820b40be2639412d89b2a3673314))
* **gateway:** support leading-dot domain patterns in GrantStore ([f2a1006](https://github.com/fuxingloh/lobu/commit/f2a1006e4a9769c90bf5521332c87a8c0ed156ff))
* harden file delivery flows and add OpenRouter CI evals ([676544c](https://github.com/fuxingloh/lobu/commit/676544c1d9871debd6116a638108ad2a757fd1af))
* **identity:** facts-as-events identity engine ([475baab](https://github.com/fuxingloh/lobu/commit/475baab3da2d13d1f45834e3f572ceb97fdc4ce3))
* inline memory config into lobu.toml and rename devops→engineering ([#247](https://github.com/fuxingloh/lobu/issues/247)) ([1daf272](https://github.com/fuxingloh/lobu/commit/1daf2728bec2b374a52c2212231ae641f439e89a))
* **landing:** add connect-from pages and refresh use-case content ([1ce6f6c](https://github.com/fuxingloh/lobu/commit/1ce6f6c0754aa8adfa45f6dc0738f5931717dbf1))
* **landing:** add interactive prompt + output demo to skills section ([dc8a806](https://github.com/fuxingloh/lobu/commit/dc8a80640d748dc9a9bf46b7223d3739a52e1770))
* **landing:** add memory benchmarks section + methodology docs ([#242](https://github.com/fuxingloh/lobu/issues/242)) ([28e2980](https://github.com/fuxingloh/lobu/commit/28e2980796ed037aca37f90ab7785f95050c83d0))
* **landing:** add posthog analytics ([b7b431d](https://github.com/fuxingloh/lobu/commit/b7b431d0bc30ddb1a104ed2473ab1aa7d695577c))
* **landing:** add siloed-vs-shared memory topology section ([#375](https://github.com/fuxingloh/lobu/issues/375)) ([c759955](https://github.com/fuxingloh/lobu/commit/c7599556764bc1b9437f55b85e966ccb84c70b6c))
* **landing:** add terms of service page ([0347573](https://github.com/fuxingloh/lobu/commit/0347573d58d5aff6594713bb4a7277f7227d9e83))
* **landing:** architecture diagram badges, blog section, and use-case chat examples ([#206](https://github.com/fuxingloh/lobu/issues/206)) ([969e5ee](https://github.com/fuxingloh/lobu/commit/969e5ee6e96858521187c7af8aaeeb35786516d3))
* **landing:** canonical https://lobu.ai/mcp endpoint with OAuth proxy and tracing ([#389](https://github.com/fuxingloh/lobu/issues/389)) ([29c6d2f](https://github.com/fuxingloh/lobu/commit/29c6d2f74ff622c6f1a78ec8c359a13f88c9ba1c))
* **landing:** consolidate use-case demo into unified trace view ([#226](https://github.com/fuxingloh/lobu/issues/226)) ([c030fa7](https://github.com/fuxingloh/lobu/commit/c030fa709bcd9423224214276e3cd315cce67cff))
* **landing:** embed OpenClaw creator tweet confirming single-user design ([4c6537b](https://github.com/fuxingloh/lobu/commit/4c6537b03aaa7218191c18a69b3b8d00c82e2297))
* **landing:** link OpenClaw runtime to comparison page with architecture reasoning ([2977bbb](https://github.com/fuxingloh/lobu/commit/2977bbb16d3415459793bacf1f3d769a763268b6))
* **landing:** per-use-case chat switcher on platform pages ([#202](https://github.com/fuxingloh/lobu/issues/202)) ([f65cc35](https://github.com/fuxingloh/lobu/commit/f65cc3567a30059c8589264610f4531ec11e89e8))
* **landing:** publish agent-readiness signals for lobu.ai ([#208](https://github.com/fuxingloh/lobu/issues/208)) ([8360cef](https://github.com/fuxingloh/lobu/commit/8360cefd6401afa1271f21a01f11a09231aada09))
* **landing:** remove Lobu for X labels and redundant use case summaries ([e861218](https://github.com/fuxingloh/lobu/commit/e861218120dbfc5265152bd09b2ab96a6202f5c3))
* **landing:** rename skills-as-saas to skills and update hero copy ([42009c5](https://github.com/fuxingloh/lobu/commit/42009c5d709cbdac0455512326757813d7f27805))
* **landing:** replace Telegram chat with terminal log for connections row ([2a3467e](https://github.com/fuxingloh/lobu/commit/2a3467e385bef38a1f066ed90482f1bd91cf5b3b))
* **landing:** restore Integrate dropdown on copy-prompt CTAs ([#289](https://github.com/fuxingloh/lobu/issues/289)) ([bf565f1](https://github.com/fuxingloh/lobu/commit/bf565f190a3f211b6be5b135fe0cb1cda1f1f1e7))
* **landing:** revamp memory page demo ([96dba19](https://github.com/fuxingloh/lobu/commit/96dba192e07b7861b333c9d7f3fc72701527436a))
* **landing:** rewrite hero headline and subhead for agent-first pitch ([#312](https://github.com/fuxingloh/lobu/issues/312)) ([044b1ed](https://github.com/fuxingloh/lobu/commit/044b1ed5eb2fa1ea578701673cc1922afeee1e3d))
* **landing:** subtle hero and scroll-reveal animations ([#265](https://github.com/fuxingloh/lobu/issues/265)) ([256db16](https://github.com/fuxingloh/lobu/commit/256db16f53b7302fef91cf266c57b4f478383edf))
* **landing:** swap outcome channel and platform badges in demo ([#290](https://github.com/fuxingloh/lobu/issues/290)) ([fa8bca5](https://github.com/fuxingloh/lobu/commit/fa8bca5037d027cb4eb6cf8a43d5c85b65ba11b1))
* **landing:** update copy prompt behavior and text ([a551a79](https://github.com/fuxingloh/lobu/commit/a551a7965c9c46aa2b44e2a29eecd065fd9c1f13))
* make examples/ single source of truth for use cases and Owletto orgs ([3fc5380](https://github.com/fuxingloh/lobu/commit/3fc5380a720681d4b54ca88ff401dcaa7462db70))
* make Hero GitHub button contextual to active use case ([f1ca9fe](https://github.com/fuxingloh/lobu/commit/f1ca9fed7cfbe4326599e546109eca7f6a45bb05))
* make skills page init preview contextual to selected use-case ([146e87a](https://github.com/fuxingloh/lobu/commit/146e87ad8838c5dd03c5f27900636e05c527823f))
* **mcp-auth:** surface login prompts as platform link buttons ([9ca5449](https://github.com/fuxingloh/lobu/commit/9ca5449a48321db1e6a81f3ab1172b8768f272fc))
* migrate browser-auth to REST, demote manage_* to internal MCP ([#439](https://github.com/fuxingloh/lobu/issues/439)) ([9f883a5](https://github.com/fuxingloh/lobu/commit/9f883a5d56c92665da27bce37886d97e665565d5))
* migrate owletto examples to models/ directory with type field ([3deeb77](https://github.com/fuxingloh/lobu/commit/3deeb77f5eea1cd9d1124691e42430e3bb6fa496))
* migrate Owletto plugin to published @lobu/owletto-openclaw package ([b4666c5](https://github.com/fuxingloh/lobu/commit/b4666c50c375331aaf5fd2b8802b6891974459e0))
* migrate to Chat SDK platform adapters with typed OpenAPI schemas ([89573db](https://github.com/fuxingloh/lobu/commit/89573dbf3242249034f37543671db26493ccbd88))
* **oauth:** add PKCE, RFC 8707 resource, auto-grants, and MCP token endpoint ([63336a7](https://github.com/fuxingloh/lobu/commit/63336a78d92999384fa873216668467a2787666c))
* **observability:** vendor-neutral OTEL tracing + opt-in Sentry ([#172](https://github.com/fuxingloh/lobu/issues/172)) ([f3345d3](https://github.com/fuxingloh/lobu/commit/f3345d364cfa28c9cc8f9c801041ccb1fd492b5c))
* **otel:** switch from OTLP HTTP to gRPC exporter (port 4317) ([60178db](https://github.com/fuxingloh/lobu/commit/60178db403596efadcd3124e367b06287f7696ba))
* **owletto-backend:** 401 + WWW-Authenticate for unauth /mcp ([#438](https://github.com/fuxingloh/lobu/issues/438)) ([ae703fa](https://github.com/fuxingloh/lobu/commit/ae703fa69478fc3d54a464ef3e7c99a51c3bff7c))
* **owletto-backend:** accept entity_link_overrides at install/create/connect ([#318](https://github.com/fuxingloh/lobu/issues/318)) ([c08e052](https://github.com/fuxingloh/lobu/commit/c08e0521df83b78fd669ce794110e61e49429443))
* **owletto-backend:** allow lobu.ai to embed app via CSP frame-ancestors ([#246](https://github.com/fuxingloh/lobu/issues/246)) ([6cbf3d2](https://github.com/fuxingloh/lobu/commit/6cbf3d29aafee5b5c80f389c25e54c9eb3afc267))
* **owletto-backend:** centralize transactional email + rebrand to Lobu ([#314](https://github.com/fuxingloh/lobu/issues/314)) ([4db7a1e](https://github.com/fuxingloh/lobu/commit/4db7a1e2e3dc7c214f13fa5d0bea885db080617a))
* **owletto-backend:** gate $member list to members, emails to admins ([#309](https://github.com/fuxingloh/lobu/issues/309)) ([c37c72f](https://github.com/fuxingloh/lobu/commit/c37c72f6473838163149b12c8677d8dda6acabb2))
* **owletto-backend:** multi-org execute + search MCP tools ([#348](https://github.com/fuxingloh/lobu/issues/348)) ([bb4ff94](https://github.com/fuxingloh/lobu/commit/bb4ff94d046acc4c8db74e5585764bb592e925a9))
* **owletto-backend:** public-org read access + self-serve join ([#296](https://github.com/fuxingloh/lobu/issues/296)) ([38cf00f](https://github.com/fuxingloh/lobu/commit/38cf00f09c51d57fbe5d1fb3f8811f84b2d35756))
* **owletto-backend:** split MCP execute into query (read-only) + run (full) ([#432](https://github.com/fuxingloh/lobu/issues/432)) ([aef8254](https://github.com/fuxingloh/lobu/commit/aef825435dbc4a5015b5f6cc35419940e245e6a5))
* **owletto:** absorb skills, benchmarks, and dev scripts from deprecated owletto repo ([#231](https://github.com/fuxingloh/lobu/issues/231)) ([ccef71e](https://github.com/fuxingloh/lobu/commit/ccef71e1b2e3c58d79a767a84f919777b724cc44))
* **owletto:** consolidate CLI profiles into lobu.toml ([#233](https://github.com/fuxingloh/lobu/issues/233)) ([577ec37](https://github.com/fuxingloh/lobu/commit/577ec3731c70faea3272128b26ad2787d4198a99))
* refresh cli docs and restore release publish chain ([#179](https://github.com/fuxingloh/lobu/issues/179)) ([1ee0595](https://github.com/fuxingloh/lobu/commit/1ee0595d354b0dee1a85d4b3015fd1c9adcab4a0))
* refresh landing pages and pricing UX ([c8d8b58](https://github.com/fuxingloh/lobu/commit/c8d8b58fd6ea4b16583d67259e61839dc9ee1f52))
* rename CTA to "Open in Owletto" and open in new tab ([179fc23](https://github.com/fuxingloh/lobu/commit/179fc239b240a31aabd3d412a98035353b638924))
* **settings:** add generic OpenAI provider ([fcae8c3](https://github.com/fuxingloh/lobu/commit/fcae8c30497d52263787930588763b64934160ae))
* **settings:** add generic OpenAI provider ([f60e93a](https://github.com/fuxingloh/lobu/commit/f60e93af00324191d7f842cb4f99ec8501aa5e04))
* **settings:** post-install callback with agent resume ([d96e99b](https://github.com/fuxingloh/lobu/commit/d96e99b120054cebad862f788eef427faefb4e40))
* show nix packages in landing skill previews ([6095e13](https://github.com/fuxingloh/lobu/commit/6095e13447d9d7c3e6214a9995b9994645ee8bf9))
* **skills:** add scoring, URI, and system skill search to SearchSkills ([d63d7a8](https://github.com/fuxingloh/lobu/commit/d63d7a8e1a0b16dfcd8761a1ed54690cd84616c6))
* subdomain-aware SPA + SSR routing ([#234](https://github.com/fuxingloh/lobu/issues/234)) ([9c66f16](https://github.com/fuxingloh/lobu/commit/9c66f16cd4b16d96356de05e3aa401e6499f0d5e))
* **watchers:** in-process lifecycle tracker, durable correlation, drop heartbeat ([#336](https://github.com/fuxingloh/lobu/issues/336)) ([51be366](https://github.com/fuxingloh/lobu/commit/51be366129315ffcc1c7f94bdc135e541eaf4a3a))
* **watchers:** per-field feedback storage with mutation kinds ([#363](https://github.com/fuxingloh/lobu/issues/363)) ([5e0c16e](https://github.com/fuxingloh/lobu/commit/5e0c16ed4012a2e4330ae5802d60c1752797c4b9))
* wire file-first owletto memory config ([46c7554](https://github.com/fuxingloh/lobu/commit/46c7554d27284724333d5aa043316fe208f278b1))
* **worker,backend:** capture subprocess output and exit metadata on run records ([#376](https://github.com/fuxingloh/lobu/issues/376)) ([02eb47a](https://github.com/fuxingloh/lobu/commit/02eb47a2af63b57538a75393a576d76ceb0ff2ab))
* **worker:** expand ConnectService to support AI provider setup ([45b0c93](https://github.com/fuxingloh/lobu/commit/45b0c9396a759a14eb67c22347aee2de08e4543e))
* **worker:** generic MCP login tools + bash hardening ([5e167a4](https://github.com/fuxingloh/lobu/commit/5e167a41bf87f71704c7f936759624a26e959e85))
* **worker:** redact sandbox leaks, replace base prompt identity, use signed artifact URLs ([a5c33d8](https://github.com/fuxingloh/lobu/commit/a5c33d818d9de4e0bef8fd1710a2244f8592e33f))
* **world-model:** allow read-only cross-org list_rules ([#399](https://github.com/fuxingloh/lobu/issues/399)) ([b30dc63](https://github.com/fuxingloh/lobu/commit/b30dc6347eea136a78d7b24fb98f63e0bbdc5ef0))
* **world-model:** cross-org references — schema search path + write guard ([#374](https://github.com/fuxingloh/lobu/issues/374)) ([426b2e2](https://github.com/fuxingloh/lobu/commit/426b2e2efda58dc73f57cb510ad4afe3cf4c7549))
* **world-model:** cross-org relationship_types + catalog discovery ([#377](https://github.com/fuxingloh/lobu/issues/377)) ([bfb7dfb](https://github.com/fuxingloh/lobu/commit/bfb7dfbd05c45047b2cecc2a2d07897da2f23f17))
* **world-model:** cross-org schema CRUD + read-side tolerance ([#386](https://github.com/fuxingloh/lobu/issues/386)) ([1fbdd35](https://github.com/fuxingloh/lobu/commit/1fbdd35f02a0a3ebf08b36ffd7a5758581441ee4))


### Bug Fixes

* **auth:** align Claude OAuth client with public CLI to avoid 429 ([#345](https://github.com/fuxingloh/lobu/issues/345)) ([aa91a81](https://github.com/fuxingloh/lobu/commit/aa91a81da7ce0caa1afa18f3ab37a24888f37502))
* **ci:** add group-pull-request-title-pattern for merge plugin ([#200](https://github.com/fuxingloh/lobu/issues/200)) ([d01fe2e](https://github.com/fuxingloh/lobu/commit/d01fe2ebe30bba653775a683458c667ead5697fd))
* **ci:** bump landing deploy to Node 22 for Astro 6 ([#344](https://github.com/fuxingloh/lobu/issues/344)) ([1eb9d60](https://github.com/fuxingloh/lobu/commit/1eb9d603cb1c6be549ac6b8927f4875d024253b7))
* **ci:** correct jq precedence in codex-auto-approve lookup ([#300](https://github.com/fuxingloh/lobu/issues/300)) ([86063c6](https://github.com/fuxingloh/lobu/commit/86063c647af6f92c0cd8f32b46f0237ff3487c7d))
* **ci:** deploy landing functions by running wrangler from packages/landing ([#391](https://github.com/fuxingloh/lobu/issues/391)) ([7c3676b](https://github.com/fuxingloh/lobu/commit/7c3676be2c34ae4e9c7b9710a4d464882e53fa7e))
* **ci:** drop package-name from release-please config to fix auto-tagging ([#190](https://github.com/fuxingloh/lobu/issues/190)) ([31056a2](https://github.com/fuxingloh/lobu/commit/31056a2e8af8e9347aa7e6680109162e85509f17))
* **ci:** gate release steps on explicit true output ([47346e5](https://github.com/fuxingloh/lobu/commit/47346e54a866bc6700413e34621387b61d5cb924))
* **ci:** guard docker sha tags on release events ([#181](https://github.com/fuxingloh/lobu/issues/181)) ([48b75ac](https://github.com/fuxingloh/lobu/commit/48b75ac8154c801bbdc8676412cf5fabe804d8aa))
* **ci:** include component in title pattern to fix release-please auto-tagging ([#194](https://github.com/fuxingloh/lobu/issues/194)) ([deaa3dc](https://github.com/fuxingloh/lobu/commit/deaa3dca4737fefb502d7982f37ed75abb122e33))
* **ci:** include component in title pattern to fix release-please auto-tagging ([#196](https://github.com/fuxingloh/lobu/issues/196)) ([524e715](https://github.com/fuxingloh/lobu/commit/524e715fe8da91adc8eb133afac18250b4010916))
* **ci:** initialize owletto-web submodule in landing deploy ([#229](https://github.com/fuxingloh/lobu/issues/229)) ([0dee7bc](https://github.com/fuxingloh/lobu/commit/0dee7bc8c229562b9335aa226f765af563fe25f5))
* **ci:** pin bun version for landing deploy ([0c62bf0](https://github.com/fuxingloh/lobu/commit/0c62bf09804b9e5851c51f85b22fdbafd744f278))
* **ci:** put version in release-please PR title + add workflow_dispatch ([#176](https://github.com/fuxingloh/lobu/issues/176)) ([9021308](https://github.com/fuxingloh/lobu/commit/9021308ed7162a7bd20e08817c351a64684ed7c1))
* **ci:** reconcile release-please config + Chart.yaml appVersion ([#174](https://github.com/fuxingloh/lobu/issues/174)) ([c6ea7c8](https://github.com/fuxingloh/lobu/commit/c6ea7c8368f312f2deb10deb5e723ef76e23ece6))
* **ci:** release-please triggers publish-packages via gh workflow run ([87b14cb](https://github.com/fuxingloh/lobu/commit/87b14cbaea46df47be6e5a71d7fc498523c23995))
* **ci:** remove invalid secrets check from eval workflow job condition ([1889cc4](https://github.com/fuxingloh/lobu/commit/1889cc47c6b10c43d78a2a91e92f9ff5924c1559))
* **ci:** repair broken npm publish workflows ([6f6ea08](https://github.com/fuxingloh/lobu/commit/6f6ea08ec2f2d15e10933c1ecd993fe205dad55f))
* **ci:** restore release config for package releases ([6c7190c](https://github.com/fuxingloh/lobu/commit/6c7190ceff17b4b113e9036b5663c40ec01fe19f))
* **ci:** restore release manifest for package releases ([892cdc5](https://github.com/fuxingloh/lobu/commit/892cdc5d3fa91db47bd06e44ad1e9507a57f0f58))
* **ci:** restore release-please pull-request-title-pattern ([#186](https://github.com/fuxingloh/lobu/issues/186)) ([699f40b](https://github.com/fuxingloh/lobu/commit/699f40b0cf9375b25a76733f7351ca934730fe9d))
* **ci:** set empty component to fix release-please auto-tagging ([#192](https://github.com/fuxingloh/lobu/issues/192)) ([ec809f9](https://github.com/fuxingloh/lobu/commit/ec809f9069f0a8b79b0fab0b37eeb409783da67e))
* **ci:** set include-component-in-tag true so release-please auto-tags ([#197](https://github.com/fuxingloh/lobu/issues/197)) ([85cc88a](https://github.com/fuxingloh/lobu/commit/85cc88ae1c6ff4d4b69c276824162206bc5e0d3a))
* **ci:** skip web build when owletto-web is stubbed ([#222](https://github.com/fuxingloh/lobu/issues/222)) ([acee38a](https://github.com/fuxingloh/lobu/commit/acee38aae91b8389553800ccdbbace542460b89f))
* **ci:** sync bun lockfile ([16c91dd](https://github.com/fuxingloh/lobu/commit/16c91dd052f7571da9c144787afef670ccc09338))
* **ci:** upgrade npm to latest for OIDC trusted publishing ([a85bbb2](https://github.com/fuxingloh/lobu/commit/a85bbb280ea814c8ab6c8c2d576b18cd14817ff6))
* **ci:** use default release-please title pattern variables ([#178](https://github.com/fuxingloh/lobu/issues/178)) ([26709e3](https://github.com/fuxingloh/lobu/commit/26709e3c19e01ebf58220118a056833caf6ea50b))
* **ci:** use GitHub secret for Telegram token, not k8s sealed secret ([ff27697](https://github.com/fuxingloh/lobu/commit/ff27697611db35e5c7d1c31e0b6fdcd1f27c045e))
* **ci:** use Node 24 for bundled npm 11 (OIDC trusted publishing) ([3697004](https://github.com/fuxingloh/lobu/commit/3697004f3cf00a41e0dcbdaae2f7e539e9a7d00b))
* **ci:** use NODE_AUTH_TOKEN for npm auth instead of manual .npmrc ([606a82b](https://github.com/fuxingloh/lobu/commit/606a82ba9d7879a0a028fb63d1ab09e7e3f6326c))
* **ci:** use OIDC trusted publishing, drop stale NPM_TOKEN path ([e8f5ca0](https://github.com/fuxingloh/lobu/commit/e8f5ca08c70be3f0afc2b29c3f5ac3b78e0c8669))
* **ci:** use simpler release-please title pattern that actually works ([#188](https://github.com/fuxingloh/lobu/issues/188)) ([11e1e70](https://github.com/fuxingloh/lobu/commit/11e1e7056674b1ed67be9678ed4c1fa2a988a9c2))
* **ci:** use yaml updater for Chart.yaml version + appVersion ([58819bc](https://github.com/fuxingloh/lobu/commit/58819bc604ed04448a10e8a67535c8b1ff470911))
* **cli:** auth reliability — server-side logout, --force login, stale cred cleanup, concurrent refresh ([b0ee7a3](https://github.com/fuxingloh/lobu/commit/b0ee7a3cf89be660254febed38481f26f7a95eec))
* **cli:** hide hidden skills from 'lobu skills list' ([abbf99e](https://github.com/fuxingloh/lobu/commit/abbf99e93a6a60e2828e6222324835b2faac403e))
* **cli:** migrate to @inquirer/prompts to fix Node 25 readline crash ([#364](https://github.com/fuxingloh/lobu/issues/364)) ([8ab0dd9](https://github.com/fuxingloh/lobu/commit/8ab0dd9c9d41f9bc8436a7e2d038f78bb5453f50))
* **cli:** replace RequestInfo with portable fetch input type ([ba23c4a](https://github.com/fuxingloh/lobu/commit/ba23c4a260949f75e81876dd4e85e35449d5cada))
* **cli:** restore system skills and add CLI to publish workflow ([1fc3687](https://github.com/fuxingloh/lobu/commit/1fc3687985505bf6dd9133b94f162bdd568947c4))
* **connector-catalog,worker-auth:** externalize on resolve fail; pino err serialization ([#405](https://github.com/fuxingloh/lobu/issues/405)) ([eb84fe4](https://github.com/fuxingloh/lobu/commit/eb84fe4f8d3ceebbd40fceaf47291092504bb4cb))
* **db:** add dbmate up/down directives to repair-agent migrations ([#390](https://github.com/fuxingloh/lobu/issues/390)) ([8a115dd](https://github.com/fuxingloh/lobu/commit/8a115dd520ee3c9768f2aebcf5ea262eb49ab23d))
* **db:** backfill events.created_by NULLs before NOT NULL validate ([#392](https://github.com/fuxingloh/lobu/issues/392)) ([bb7cce3](https://github.com/fuxingloh/lobu/commit/bb7cce3b5ca8de9a6825c8ed7cf9984430c2ac81))
* **db:** drop CONCURRENTLY from migration's index recreation ([#402](https://github.com/fuxingloh/lobu/issues/402)) ([bccd3da](https://github.com/fuxingloh/lobu/commit/bccd3daceae6ddc444004e723a8cfa01bd7177d8))
* **db:** drop CONCURRENTLY from migration's index recreation ([#403](https://github.com/fuxingloh/lobu/issues/403)) ([7870f0d](https://github.com/fuxingloh/lobu/commit/7870f0dab002004ae1569cffb54b064d07651182))
* **db:** drop legacy event source id ([#419](https://github.com/fuxingloh/lobu/issues/419)) ([560c073](https://github.com/fuxingloh/lobu/commit/560c0731b10197bd8dc40c5781cfed517bffb111))
* **db:** scope baseline's search_path reset to migration transaction ([#406](https://github.com/fuxingloh/lobu/issues/406)) ([ba33bae](https://github.com/fuxingloh/lobu/commit/ba33baec1013ec209c966eb961fa86a634bac27f))
* **db:** SET lock_timeout = 0 for events.created_by backfill ([#396](https://github.com/fuxingloh/lobu/issues/396)) ([5224b92](https://github.com/fuxingloh/lobu/commit/5224b92a464956ef32b3373fd1706a6f771756c8))
* **db:** single UPDATE backfill — chunked DO LOOP exceeded liveness budget ([#395](https://github.com/fuxingloh/lobu/issues/395)) ([b9cd8ca](https://github.com/fuxingloh/lobu/commit/b9cd8cad38d0b85ef9762b9370bcd4656e8a4835))
* deduplicate owletto URL logic, fix skills card title, add skills link to memory reuse step ([78ad65e](https://github.com/fuxingloh/lobu/commit/78ad65e75faa689fbaa3715c0cc3eec1496c8527))
* **deploy:** remove broken global.imageRegistry that caused double-slash in Bitnami Redis image paths ([e37d81c](https://github.com/fuxingloh/lobu/commit/e37d81c79593234b9fb44aa2f2e1b9150fa3678f))
* **deploy:** update sealed secrets with all required keys ([fbe588e](https://github.com/fuxingloh/lobu/commit/fbe588e8296746a29f1ddb12af56f56856f3b420))
* **deps:** sync bun.lock with release-please 3.6.0 version bump ([#227](https://github.com/fuxingloh/lobu/issues/227)) ([e14500c](https://github.com/fuxingloh/lobu/commit/e14500c1ab0d60e50ad38c5c59b8b4f8fa45362b))
* **docker:** build gateway dist + exclude tests from backend typecheck ([#219](https://github.com/fuxingloh/lobu/issues/219)) ([96b0033](https://github.com/fuxingloh/lobu/commit/96b00332c637262d6a22bc624ddee802e938d519))
* **docker:** include owletto workspaces in Dockerfile.worker ([#274](https://github.com/fuxingloh/lobu/issues/274)) ([2aa042b](https://github.com/fuxingloh/lobu/commit/2aa042bce577fd4c498a5defbaa532515b39dd23))
* **docker:** name owletto-cli stub package as 'owletto' (unscoped) ([#215](https://github.com/fuxingloh/lobu/issues/215)) ([17fba3f](https://github.com/fuxingloh/lobu/commit/17fba3fac7b910f39d3bad256befa85e9ad9876c))
* **docker:** unzip in runtime + worker chromium install via bunx ([#216](https://github.com/fuxingloh/lobu/issues/216)) ([019253e](https://github.com/fuxingloh/lobu/commit/019253e8977cf8b0c14b38d5045abd6952b25a5c))
* **docker:** use bun run build for owletto-web (local vite) ([#221](https://github.com/fuxingloh/lobu/issues/221)) ([7734259](https://github.com/fuxingloh/lobu/commit/7734259b4886b2ab1cbb44468a689b8b5aff33f2))
* **docs:** correct outdated references across documentation ([b78fa65](https://github.com/fuxingloh/lobu/commit/b78fa65611ca556fb672b52a950c03e73c741cab))
* **docs:** fix Teams Chat SDK link and update CLI generated files list ([737a3d7](https://github.com/fuxingloh/lobu/commit/737a3d747aa9cc62f9d8334743c1a22167357159))
* **embedded-lobu:** make the embedded gateway boot cleanly in the owletto app image ([#332](https://github.com/fuxingloh/lobu/issues/332)) ([c378015](https://github.com/fuxingloh/lobu/commit/c378015e51adf7fbf688684bcb1684680b2f38d3))
* **eval:** continue running remaining evals after individual failures ([8187b7f](https://github.com/fuxingloh/lobu/commit/8187b7f3f9422b3ec919878f64034be40e70cc17))
* **eval:** create data dir for Redis persistence in CI ([3f7f598](https://github.com/fuxingloh/lobu/commit/3f7f598ea25aa3a03a2da2465ebe1bfcb27e9bd7))
* **eval:** disable Redis RDB persistence in CI to avoid MISCONF errors ([c131bbb](https://github.com/fuxingloh/lobu/commit/c131bbb4eeaa8c628d9528963ecf9fad66741752))
* **eval:** don't override provider/model unless --model flag is set ([8b8bd4b](https://github.com/fuxingloh/lobu/commit/8b8bd4b1c02d6c630da41c900973604c69b32487))
* **eval:** don't pass provider/model to session creation, use agent config ([49f3b4d](https://github.com/fuxingloh/lobu/commit/49f3b4df506751b5b1a62ede913e5abc9c84f761))
* **eval:** improve judge prompts with prose fallback, CI runs smoke only ([6876107](https://github.com/fuxingloh/lobu/commit/6876107f5620341056bc821accaad33d14d15333))
* **eval:** isolate trials + feat(worker): MCP-as-CLI for embedded mode ([#184](https://github.com/fuxingloh/lobu/issues/184)) ([c256d6d](https://github.com/fuxingloh/lobu/commit/c256d6d2604b514df9eb2c5658524079286e73b9))
* **eval:** pass Z_AI_API_KEY to gateway container in docker-compose ([ad890e3](https://github.com/fuxingloh/lobu/commit/ad890e35add1fee8285b241415b53d1984a2302d))
* **events:** make creator attribution nullable ([#418](https://github.com/fuxingloh/lobu/issues/418)) ([b7f59f5](https://github.com/fuxingloh/lobu/commit/b7f59f51f2041b5ffb42e2e025881190f599eac7))
* **events:** tolerate stale client_id refs on insert + relax FK ([#339](https://github.com/fuxingloh/lobu/issues/339)) ([5c19d26](https://github.com/fuxingloh/lobu/commit/5c19d26bdf6604aba88c44ee437773abb2e9f071))
* **execute:** bundle backend so prod runs under Node + isolated-vm ([#433](https://github.com/fuxingloh/lobu/issues/433)) ([20afae5](https://github.com/fuxingloh/lobu/commit/20afae540b02983e47a38d8cb7650b15f2907a5d))
* **execute:** harden sandbox runtime ([#427](https://github.com/fuxingloh/lobu/issues/427)) ([343cc03](https://github.com/fuxingloh/lobu/commit/343cc03962ef4e26e795664f7a07ca50716dc724))
* **execute:** run backend under Node so isolated-vm loads ([#430](https://github.com/fuxingloh/lobu/issues/430)) ([71c74e1](https://github.com/fuxingloh/lobu/commit/71c74e18600c8d5c1c21c0638b994a05aefbc687))
* **gateway,dev-native:** thread worker entryPoint through config, unblock native dev ([#347](https://github.com/fuxingloh/lobu/issues/347)) ([e5ff4d8](https://github.com/fuxingloh/lobu/commit/e5ff4d8d5bd73b02cf010d64a668610a4fde7767))
* **gateway,worker:** deliver provider base URLs via session context only ([#225](https://github.com/fuxingloh/lobu/issues/225)) ([9171d37](https://github.com/fuxingloh/lobu/commit/9171d37d34cbe07fd004ee2e7842b8a66328e46b))
* **gateway:** escape user input in MCP OAuth callback to prevent XSS ([#284](https://github.com/fuxingloh/lobu/issues/284)) ([ab19e8a](https://github.com/fuxingloh/lobu/commit/ab19e8ac569df321866921fd64b59bca9d01920d))
* **gateway:** gate agent API handlers with ownership check to prevent cross-tenant access ([#285](https://github.com/fuxingloh/lobu/issues/285)) ([ec8ff6b](https://github.com/fuxingloh/lobu/commit/ec8ff6bb28389acc023a9b363bb8bbd7813518ad))
* **gateway:** isolate tsconfig from root bun-types ([#220](https://github.com/fuxingloh/lobu/issues/220)) ([c533e27](https://github.com/fuxingloh/lobu/commit/c533e274217d2af6177f902fd4cf0502f73192b5))
* **gateway:** Owletto MCP sync, Slack markdown/threading, tool-approval lifecycle, deployment coalescing ([#210](https://github.com/fuxingloh/lobu/issues/210)) ([92ce0eb](https://github.com/fuxingloh/lobu/commit/92ce0eb3308e4d4b476c96b60d5f8e45803d9597))
* **gateway:** preserve base path when mounted as sub-app ([edc0be5](https://github.com/fuxingloh/lobu/commit/edc0be54a5a1d56d771a0b70541d3752306779f9))
* **gateway:** publish embedded runtime packages ([148e7dc](https://github.com/fuxingloh/lobu/commit/148e7dcfb47b8a29c5e7f14926a55a3b5754e09b))
* **gateway:** require worker auth on /api/bedrock/* to prevent unauthenticated AWS spend ([#287](https://github.com/fuxingloh/lobu/issues/287)) ([5e6e91c](https://github.com/fuxingloh/lobu/commit/5e6e91c32a75e872a052705854277d8114b5c240))
* **gateway:** skip enqueuing worker delivery receipts to thread response queue ([c5c352d](https://github.com/fuxingloh/lobu/commit/c5c352d50b9dfd80570bb78743735eb94adb38d3))
* **helm:** expose ADMIN_PASSWORD and platform tokens as gateway env vars ([968f4a8](https://github.com/fuxingloh/lobu/commit/968f4a89b230c0608a48f851fcda7f77ce046992))
* **helm:** make claude-code-oauth-token secret ref optional ([992a2e6](https://github.com/fuxingloh/lobu/commit/992a2e6c2652781975285bd0b14618990c90ded0))
* **helm:** remove platform token env vars from gateway deployment ([062f18f](https://github.com/fuxingloh/lobu/commit/062f18f71f82538c0ee343e608e4861e78e9a281))
* **landing:** bold connector label inline instead of separate heading ([3ac690e](https://github.com/fuxingloh/lobu/commit/3ac690e5f803408fa8ee4a91ebd87f9ecdf07138))
* **landing:** clarify use-case source CTA ([d0b64f2](https://github.com/fuxingloh/lobu/commit/d0b64f2367c4c0f7e8c815c2ae89d92047ae38d8))
* **landing:** correct homepage prompt and CLI command references ([5f4429f](https://github.com/fuxingloh/lobu/commit/5f4429fa118a23018df97db83cda7c8a62760602))
* **landing:** correct owletto demo links ([150a7c9](https://github.com/fuxingloh/lobu/commit/150a7c94f26b04e51271e6dc9074a649eb178099))
* **landing:** defer cal.com iframe until schedule dialog opens ([#398](https://github.com/fuxingloh/lobu/issues/398)) ([d86e7db](https://github.com/fuxingloh/lobu/commit/d86e7dbcfedee084911b778042ab7b1786c6cd59))
* **landing:** improve hero CTA labels ([ae6a807](https://github.com/fuxingloh/lobu/commit/ae6a807ae33679770e7f851ab0f4c8ef5dce2c3a))
* **landing:** inline connector labels to balance recall/auth column heights ([6125016](https://github.com/fuxingloh/lobu/commit/61250162d3a4b28fccfcb273282e39afbc000a69))
* **landing:** keep homepage hero generic ([8078103](https://github.com/fuxingloh/lobu/commit/807810394c3d6ed87aa445075b4e9b7e4e248136))
* **landing:** left-align skills workspace preview ([54519ca](https://github.com/fuxingloh/lobu/commit/54519cab40a6f157c5f19761e7e5a3ca6a565813))
* **landing:** move outcome channel into outcome box ([#306](https://github.com/fuxingloh/lobu/issues/306)) ([885ab61](https://github.com/fuxingloh/lobu/commit/885ab6171bbc3e347e32c3dbf36583eef2b4f215))
* **landing:** point Scalar API reference at the real /openapi.json ([#394](https://github.com/fuxingloh/lobu/issues/394)) ([8046abe](https://github.com/fuxingloh/lobu/commit/8046abe0b1eac7f1fd03bda8463f4146158fa0cd))
* **landing:** refine Owletto memory section copy ([#205](https://github.com/fuxingloh/lobu/issues/205)) ([9075d6c](https://github.com/fuxingloh/lobu/commit/9075d6c74f33716429b030c4406b10e28450b63d))
* **landing:** repair broken links surfaced by audit ([#275](https://github.com/fuxingloh/lobu/issues/275)) ([1de4aee](https://github.com/fuxingloh/lobu/commit/1de4aee458e9039396f62b6d357c1c5450040b27))
* **landing:** resolve zod alias from installed package ([f09e12d](https://github.com/fuxingloh/lobu/commit/f09e12d8409a122c8f33db3bb915c84af1d9e1c9))
* **landing:** resolve zod parse error on connect-from route ([#271](https://github.com/fuxingloh/lobu/issues/271)) ([cef2284](https://github.com/fuxingloh/lobu/commit/cef2284ab1c1e10f1406f43301378036767dbafa))
* **landing:** restore campaign description from runtime.request ([#250](https://github.com/fuxingloh/lobu/issues/250)) ([56eac67](https://github.com/fuxingloh/lobu/commit/56eac673486777867c5115ba174f019a0dbe245b))
* **landing:** satisfy isitagentready.com checks for markdown + OAuth metadata ([#397](https://github.com/fuxingloh/lobu/issues/397)) ([8d84627](https://github.com/fuxingloh/lobu/commit/8d84627ed6412fa8daad7ad2d6d02d2f0d1dea8c))
* **landing:** use descriptive agent names in ConnectionsPanel ([f8f38c1](https://github.com/fuxingloh/lobu/commit/f8f38c118d703015580680eb3717c74755b2cb7b))
* **landing:** wire benchmark methodology link and add tables to memory + comparison ([#276](https://github.com/fuxingloh/lobu/issues/276)) ([39a0436](https://github.com/fuxingloh/lobu/commit/39a043696a4910f931d885dfe6baa48f5570d0fe))
* make memory step layouts consistent ([990bf61](https://github.com/fuxingloh/lobu/commit/990bf61d7af60d43c6487f99c2b73b27820e4468))
* **mcp-handler,entity-management:** SSE close race + classify entity-type errors ([#340](https://github.com/fuxingloh/lobu/issues/340)) ([4b4649a](https://github.com/fuxingloh/lobu/commit/4b4649aef22db89f8a4fe6abe787ec7bd321b01b))
* **owletto-backend:** add missing memberRole to internal ToolContext literals ([#311](https://github.com/fuxingloh/lobu/issues/311)) ([dce8105](https://github.com/fuxingloh/lobu/commit/dce8105ba0de3c4e03ba7ce268cd3e2899cc2a61))
* **owletto-backend:** exclude watcher runs from worker poll claims ([#313](https://github.com/fuxingloh/lobu/issues/313)) ([afd5d7b](https://github.com/fuxingloh/lobu/commit/afd5d7b78ed5f2125e655349079aff3b0658106e))
* **owletto-backend:** MCP rough edges — org scope, paginated SDK examples, knowledge.delete tombstone ([#442](https://github.com/fuxingloh/lobu/issues/442)) ([6f2ae98](https://github.com/fuxingloh/lobu/commit/6f2ae988b802393f6653485cacac3727c91452c9))
* **owletto-backend:** re-register list_watchers/get_watcher/read_knowledge for REST ([#434](https://github.com/fuxingloh/lobu/issues/434)) ([dac1603](https://github.com/fuxingloh/lobu/commit/dac1603f7e3c5988e3656e4753539351fd510308))
* **owletto-backend:** resolve *.lobu.ai as org subdomain under AUTH_COOKIE_DOMAIN ([#224](https://github.com/fuxingloh/lobu/issues/224)) ([c893aae](https://github.com/fuxingloh/lobu/commit/c893aaedb64ac3437e081641947dca297f390f79))
* **owletto-backend:** resolve default org when loading social credentials ([#235](https://github.com/fuxingloh/lobu/issues/235)) ([90419cc](https://github.com/fuxingloh/lobu/commit/90419ccd931328f402f9dfbc16b97fb7f355a1a9))
* **owletto-backend:** resolve typecheck errors blocking build-images ([#218](https://github.com/fuxingloh/lobu/issues/218)) ([7ce6271](https://github.com/fuxingloh/lobu/commit/7ce62711bd2c35d763d01f35426e24e07dc88bf4))
* **owletto-backend:** unblock image builds after dead-code refactor ([#329](https://github.com/fuxingloh/lobu/issues/329)) ([5619e1f](https://github.com/fuxingloh/lobu/commit/5619e1f338c312cff299e73170e6d247a4382704))
* **owletto-backend:** use parameter binding in content-search to prevent SQL injection ([#286](https://github.com/fuxingloh/lobu/issues/286)) ([65511c1](https://github.com/fuxingloh/lobu/commit/65511c1fc2eb13a3ebd180ca341a8d74ea57a877))
* **packages:** add repository.url to all published package.json files ([c3f14c0](https://github.com/fuxingloh/lobu/commit/c3f14c04649c690ee6d5ee02a69e94f0f55de279))
* point agent-community Try Now to venture-capital org ([b117767](https://github.com/fuxingloh/lobu/commit/b117767c65e1e817a39f567ad39cc2abf2459da0))
* post-merge review follow-ups (path traversal, Sentry PII, Slack instr guard, MCP join rate-limit) ([#325](https://github.com/fuxingloh/lobu/issues/325)) ([3faad40](https://github.com/fuxingloh/lobu/commit/3faad40d0da299f683c492de84623aea2332f6eb))
* **public-pages:** serve scrapeable HTML for generic clients ([#415](https://github.com/fuxingloh/lobu/issues/415)) ([818c804](https://github.com/fuxingloh/lobu/commit/818c804fde615724d6b02c3a278345508b465919))
* **public-pages:** skip SSR shell for signed-in users ([4c31a04](https://github.com/fuxingloh/lobu/commit/4c31a04543035ac0928bc22c623025031062dfbb))
* **release:** sync helm chart to 3.0.5 ([92c5142](https://github.com/fuxingloh/lobu/commit/92c51422bc96f3267f89d607fafa47237b2709e8))
* **resolve_path:** return 4xx instead of throwing on client-input errors ([#338](https://github.com/fuxingloh/lobu/issues/338)) ([326f543](https://github.com/fuxingloh/lobu/commit/326f543a90539a7504918b8c56743140384a5f17))
* **sentry:** disable NodeSystemError integration to unblock node v24 builds ([#341](https://github.com/fuxingloh/lobu/issues/341)) ([4124e00](https://github.com/fuxingloh/lobu/commit/4124e0094129d4c625cbad5f3026bac031159542))
* session reset clears history, Telegram plain-text fallback ([7af9703](https://github.com/fuxingloh/lobu/commit/7af9703ce7fe333473f067eb6d504379041e3a23))
* set working-directory to packages/landing and deploy ./dist. ([7c3676b](https://github.com/fuxingloh/lobu/commit/7c3676be2c34ae4e9c7b9710a4d464882e53fa7e))
* **settings:** make OAuth client optional so Telegram mini app works without it ([f51abed](https://github.com/fuxingloh/lobu/commit/f51abedb6f73055bba1ee91d3e4dde42afa758cb))
* **settings:** rename "Scheduled Reminders" to "Schedules" ([6a74299](https://github.com/fuxingloh/lobu/commit/6a74299e3ac7886da3217ecc081473e5e956605b))
* **settings:** skip identity linked notification if already linked ([1674a3b](https://github.com/fuxingloh/lobu/commit/1674a3be8a08516f273f21ea2691a60213c74572))
* ship app.lobu.ai SPA + retire owletto.com defaults ([#230](https://github.com/fuxingloh/lobu/issues/230)) ([e3817d4](https://github.com/fuxingloh/lobu/commit/e3817d41732b51fcbde1b56e69b0da85a1fb51d8))
* stabilize multiple security and reliability gaps across gateway ([#321](https://github.com/fuxingloh/lobu/issues/321)) ([3c6efc2](https://github.com/fuxingloh/lobu/commit/3c6efc284d8273cd598ad3747922e5ac36d2316b))
* **telegram:** add platform=telegram param to provider setup URL ([61d9aed](https://github.com/fuxingloh/lobu/commit/61d9aed0ac706e33d08f469b231ec9a68f071c94))
* **telegram:** auto-enable when bot token is present ([a951747](https://github.com/fuxingloh/lobu/commit/a951747976c18d5b18930bcf6baf07da8d70a895))
* update README and landing page (Baileys→Cloud API, Anthropic→OpenRouter, bare lobu→npx) ([45ee64f](https://github.com/fuxingloh/lobu/commit/45ee64f1ced1ee883ea2db6b48c2255dc72ab229))
* use npx @lobu/cli consistently across CLI output, docs, and landing page ([ca1133c](https://github.com/fuxingloh/lobu/commit/ca1133cde710605a017a79c7dd161cf6dca11d33))
* **watchers:** include watcher_group_id in list response; bump owletto-web for inline version chip ([#435](https://github.com/fuxingloh/lobu/issues/435)) ([4f9db5a](https://github.com/fuxingloh/lobu/commit/4f9db5a1437d531e5263bf431dcefa076156c087))
* **watchers:** no-op complete_window when all events already analyzed ([#337](https://github.com/fuxingloh/lobu/issues/337)) ([495d615](https://github.com/fuxingloh/lobu/commit/495d615034804382ed9e8606a74b979f57cb0136))
* **web:** bump owletto-web for history adapter import fix ([#237](https://github.com/fuxingloh/lobu/issues/237)) ([279a3ed](https://github.com/fuxingloh/lobu/commit/279a3edabeb32080168180f33cf42ccae11f9ef0))
* **web:** bump owletto-web for public-org auth-redirect fix ([#240](https://github.com/fuxingloh/lobu/issues/240)) ([f4641eb](https://github.com/fuxingloh/lobu/commit/f4641eb163bdc78fdc90dcd5d826f62360144e69))
* **web:** bump owletto-web for sidebar auth gating ([#238](https://github.com/fuxingloh/lobu/issues/238)) ([e51458e](https://github.com/fuxingloh/lobu/commit/e51458e2998705c987c4de84478719d34d093c3e))
* **web:** bump owletto-web for sidebar gating + add reserved-subdomain parity test ([#241](https://github.com/fuxingloh/lobu/issues/241)) ([8961e58](https://github.com/fuxingloh/lobu/commit/8961e5865e99d12996e70df1679188f38ad95458))
* **web:** bump owletto-web for subdomain history adapter ([#236](https://github.com/fuxingloh/lobu/issues/236)) ([a53c978](https://github.com/fuxingloh/lobu/commit/a53c978331acb9fff5b0b2eda2830dc68a6f42e5))
* **worker:** drop unused code/signal params from computeExitReason ([#388](https://github.com/fuxingloh/lobu/issues/388)) ([7aa3406](https://github.com/fuxingloh/lobu/commit/7aa340621b6a4910b42b41682db1a538dd00d458))
* **worker:** QA hardening for careops agent (Gemini support, UploadUserFile workspace paths, dedup error messages) ([#203](https://github.com/fuxingloh/lobu/issues/203)) ([8026d5d](https://github.com/fuxingloh/lobu/commit/8026d5d341c5738961f8179a3ab9f5acb72b797e))
* **worker:** skip --import tsx when running under Bun ([#412](https://github.com/fuxingloh/lobu/issues/412)) ([39e031d](https://github.com/fuxingloh/lobu/commit/39e031d512561db27215a44469995ca11c043eb1))
* **worker:** use string concatenation for session-context URL ([09d474e](https://github.com/fuxingloh/lobu/commit/09d474e6e2e5c8ec48505196803a0d7c8beb055d))
* **world-model:** cross-org schema validation + defensive count scoping + tests ([#407](https://github.com/fuxingloh/lobu/issues/407)) ([576dae5](https://github.com/fuxingloh/lobu/commit/576dae56d48ebf87704cfc30b3f38bdcbeec1ce7))


### Performance Improvements

* **auth:** consolidate better-auth onto shared postgres.js pool ([#342](https://github.com/fuxingloh/lobu/issues/342)) ([012754a](https://github.com/fuxingloh/lobu/commit/012754ad70f78e9b25a9664133db19eafdacd747))


### Reverts

* **execute:** drop runtime swap in [#430](https://github.com/fuxingloh/lobu/issues/430) — keep prod on bun ([#431](https://github.com/fuxingloh/lobu/issues/431)) ([f6115d8](https://github.com/fuxingloh/lobu/commit/f6115d8e9f79a8cf0d145db5c5c62f54387165ef))
* **install-flow:** remove template-install pipeline ([#369](https://github.com/fuxingloh/lobu/issues/369), [#357](https://github.com/fuxingloh/lobu/issues/357), [#362](https://github.com/fuxingloh/lobu/issues/362), [#359](https://github.com/fuxingloh/lobu/issues/359) install-half) ([#372](https://github.com/fuxingloh/lobu/issues/372)) ([d5dfbc2](https://github.com/fuxingloh/lobu/commit/d5dfbc22814906999efc86fc618fb515e622f14e))


### Code Refactoring

* **core, worker:** drop unused public exports from @lobu/core ([#281](https://github.com/fuxingloh/lobu/issues/281)) ([7c5ffa4](https://github.com/fuxingloh/lobu/commit/7c5ffa40139add5f100cb34fcda4aa173b3180f2))
