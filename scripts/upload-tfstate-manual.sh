...
# Manual script to upload Terraform state to R2
# This uses environment variables or prompts for values

set -e

cd "$(dirname "$0")/../charts/peerbot/provider/hetzner" || exit 1

echo "📦 Uploading Terraform state to R2 (Manual)"
echo "==========================================="
echo ""
...
echo "Please provide R2 credentials:"
...
echo ""
echo "Next steps:"
echo "1. Set R2 credentials as GitHub Secrets:"
echo "   - R2_ACCESS_KEY_ID"
echo "   - R2_SECRET_ACCESS_KEY"
echo "2. Run GitHub Actions workflow to deploy with existing state"